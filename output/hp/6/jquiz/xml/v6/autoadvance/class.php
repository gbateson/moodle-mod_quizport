<?php
class quizport_output_hp_6_jquiz_xml_v6_autoadvance extends quizport_output_hp_6_jquiz_xml_v6 {
    ...
    function fix_js_CheckFinished(&$str, $start, $length) {
        ...
        if ($pos = strpos($substr, $search)) {
            $insert = ''
                ...
                ."			ForceQuizStatus = ".QUIZPORT_STATUS_COMPLETED.";\n"
                ."		}\n"
                ."		if (TotalWeighting > 0) {\n"
    ...
    function expand_HeaderCode() {
        ...
        if ($headercode = $this->source->single_line($headercode)) {
    ...
    function expand_ItemArray_answertext($tags,  $answer, $a) {
        ...
        return $this->source->js_value_safe($text, true);
    }
