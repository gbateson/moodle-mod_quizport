<?php
class quizport_output_hp_6_jmatch_xml_flashcard extends quizport_output_hp_6_jmatch_xml {
    var $templatefile = 'fjmatch6.ht_';
    var $js_object_type = 'JMatchFlashcard';

    // constructor function
    function quizport_output_hp_6_jmatch_xml_flashcard(&$quiz) {
