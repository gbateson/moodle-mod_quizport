<?php
class quizport_output_hp_6_jmatch_html_jmemori extends quizport_output_hp_6_jmatch_html {
    var $filetypes = array('hp_6_jmatch_html_jmemori');
    var $js_object_type = 'JMemori';

    // constructor function
    function quizport_output_hp_6_jmatch_html_jmemori(&$quiz) {
