<?php
class quizport_output_hp_6_jcloze_html_findit_a extends quizport_output_hp_6_jcloze_html_findit {
    // source file types with which this output format can be used
    var $filetypes = array('hp_6_jcloze_html_findit_a');
    var $js_object_type = 'JClozeFindItA';

    // constructor function
    function quizport_output_hp_6_jcloze_html_findit_a(&$quiz) {
        parent::quizport_output_hp_6_jcloze_html_findit($quiz);
