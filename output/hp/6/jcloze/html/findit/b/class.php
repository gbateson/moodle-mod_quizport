<?php
class quizport_output_hp_6_jcloze_html_findit_b extends quizport_output_hp_6_jcloze_html_findit {
    // source file types with which this output format can be used
    var $filetypes = array('hp_6_jcloze_html_findit_b');
    var $js_object_type = 'JClozeFindItB';

    // constructor function
    function quizport_output_hp_6_jcloze_html_findit_b(&$quiz) {
