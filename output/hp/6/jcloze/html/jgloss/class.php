<?php
class quizport_output_hp_6_jcloze_html_jgloss extends quizport_output_hp_6_jcloze_html {
    // source file types with which this output format can be used
    var $filetypes = array('hp_6_jcloze_html_jgloss');
    ...
    function quizport_output_hp_6_jcloze_html_jgloss(&$quiz) {
