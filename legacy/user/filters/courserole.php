...
class user_filter_courserole extends user_filter_type {
    ...
    function setupForm(&$mform) {
        $els = array();
        $els[] =& $mform->createElement('select', $this->_name .'_rl', null, $this->get_roles());
        $els[] =& $mform->createElement('select', $this->_name .'_ct', null, $this->get_course_categories());
        $els[] =& $mform->createElement('text', $this->_name, null);
