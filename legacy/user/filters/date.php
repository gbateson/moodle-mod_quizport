...
class user_filter_date extends user_filter_type {
    ...
    function setupForm(&$mform) {
        ...
        $els[] =& $mform->createElement('checkbox', $this->_name.'_sck', null, get_string('isafter', 'filters'));
        $els[] =& $mform->createElement('date_selector', $this->_name.'_sdt', null);
        $els[] =& $mform->createElement('checkbox', $this->_name.'_eck', null, get_string('isbefore', 'filters'));
        $els[] =& $mform->createElement('date_selector', $this->_name.'_edt', null);
        $grp =& $mform->addElement('group', $this->_name.'_grp', $this->_label, $els, '', false);
