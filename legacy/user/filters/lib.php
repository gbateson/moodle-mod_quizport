...
require_once($CFG->dirroot.'/mod/quizport/legacy/user/filters/text.php');
require_once($CFG->dirroot.'/mod/quizport/legacy/user/filters/date.php');
require_once($CFG->dirroot.'/mod/quizport/legacy/user/filters/select.php');
require_once($CFG->dirroot.'/mod/quizport/legacy/user/filters/simpleselect.php');
require_once($CFG->dirroot.'/mod/quizport/legacy/user/filters/courserole.php');
require_once($CFG->dirroot.'/mod/quizport/legacy/user/filters/globalrole.php');
require_once($CFG->dirroot.'/mod/quizport/legacy/user/filters/profilefield.php');
require_once($CFG->dirroot.'/mod/quizport/legacy/user/filters/yesno.php');
require_once($CFG->dirroot.'/mod/quizport/legacy/user/filters/user_filter_forms.php');
