    ...
    function print_html() {
        ...
        foreach($this->columns as $column => $index) {
            ...
            if($this->is_collapsible) {
                if(!empty($this->sess->collapse[$column])) {
                    $icon_hide = ' <a href="'.$this->baseurl.$this->request[TABLE_VAR_SHOW].'='.$column.'"><img src="'.$this->pixpath.'/t/switch_plus.gif" title="'.get_string('show').' '.$this->headers[$index].'" /></a>';
                }
                else if($this->headers[$index] !== NULL) {
                    $icon_hide = ' <a href="'.$this->baseurl.$this->request[TABLE_VAR_HIDE].'='.$column.'"><img src="'.$this->pixpath.'/t/switch_minus.gif" title="'.get_string('hide').' '.$this->headers[$index].'" /></a>';
                }
            }
            ...
            switch($column) {
                ...
                if($this->is_sortable) {
                    ...
                    if($primary_sort_column == 'firstname') {
                        if($primary_sort_order == SORT_ASC) {
                            $icon_sort_first = ' <img src="'.$this->pixpath.'/t/down.gif" />';
                        }
                        else {
                            $icon_sort_first = ' <img src="'.$this->pixpath.'/t/up.gif" />';
                        }
                    }
                    else if($primary_sort_column == 'lastname') {
                        if($primary_sort_order == SORT_ASC) {
                            $icon_sort_last = ' <img src="'.$this->pixpath.'/t/down.gif" />';
                        }
                        else {
                            $icon_sort_last = ' <img src="'.$this->pixpath.'/t/up.gif" />';
                        }
                    }
                ...
                if($this->is_sortable) {
                    if($primary_sort_column == $column) {
                        if($primary_sort_order == SORT_ASC) {
                            $icon_sort = ' <img src="'.$this->pixpath.'/t/down.gif" />';
                        }
                        else {
                            $icon_sort = ' <img src="'.$this->pixpath.'/t/up.gif" />';
                        }
                    }
