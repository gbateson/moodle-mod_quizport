<?php // $Id: formslib.php,v 1.129.2.15 2008/09/08 02:41:40 moodler Exp $
/**
 ...
 *
 * @author  Jamie Pratt
 * @version $Id: formslib.php,v 1.129.2.15 2008/09/08 02:41:40 moodler Exp $
...
require_once $CFG->legacylibdir.'/uploadlib.php';
...
class moodleform {
    ...
    function set_data($default_values, $slashed=false) {
        ...
        $this->set_data_formslib_js();
        // $this->set_data_formslib_css();

        $filter = $slashed ? 'stripslashes' : NULL;
        $this->_form->setDefaults($default_values, $filter);
    }

    function set_data_formslib_js() {
        $this->_form->addElement('static', 'quizport_mod_formslib_js', '',
<<<END_FORMSLIB_JS
...
END_FORMSLIB_JS
    ...
    function set_data_formslib_css() {
        $this->_form->addElement('static', 'quizport_mod_formslib_css', '',
<<<END_FORMSLIB_CSS
<style type="text/css">
    #mod-quizport-mod #quizport {
    ...
    form.mform fieldset {
      border:1px solid #DDDDDD; padding:10px 0; margin:0.7em 0; width:100%;
    }
    ...
    form.mform .fitemtitle {
      display:block; float:left; width:30%; padding:0; margin:5px 0 0 10px; text-align:right;
    }
    ...
    form.mform fieldset.felement {
      display:block; float:left; margin:5px 0 0 10px; padding:0; text-align:left; width:60%;
    }
    *************************/
    ...
    form.mform div.fhtmleditor {
      margin:0 auto 10px auto; width:600px; clear:both; float:none; padding:25px 0 20px 0;
    }
    ...
    form.mform fieldset.error {
      border:1px solid red; padding:5px; color:inherit;
    }
...
EOS;
        ...
        require_once("$CFG->legacylibdir/form/submitlink.php");
        ...
        if ($showadvancedNow === null){
            if ($this->_showAdvanced !== null){
                ...
                $showadvancedNow = get_user_preferences(
                                moodle_strtolower($this->_formName.'_showadvanced'));
            }
        }
...
MoodleQuickForm::registerElementType('checkbox', "$CFG->legacylibdir/form/checkbox.php", 'MoodleQuickForm_checkbox');
MoodleQuickForm::registerElementType('file', "$CFG->legacylibdir/form/file.php", 'MoodleQuickForm_file');
MoodleQuickForm::registerElementType('group', "$CFG->legacylibdir/form/group.php", 'MoodleQuickForm_group');
MoodleQuickForm::registerElementType('password', "$CFG->legacylibdir/form/password.php", 'MoodleQuickForm_password');
MoodleQuickForm::registerElementType('passwordunmask', "$CFG->legacylibdir/form/passwordunmask.php", 'MoodleQuickForm_passwordunmask');
MoodleQuickForm::registerElementType('radio', "$CFG->legacylibdir/form/radio.php", 'MoodleQuickForm_radio');
MoodleQuickForm::registerElementType('select', "$CFG->legacylibdir/form/select.php", 'MoodleQuickForm_select');
MoodleQuickForm::registerElementType('selectgroups', "$CFG->legacylibdir/form/selectgroups.php", 'MoodleQuickForm_selectgroups');
MoodleQuickForm::registerElementType('submitlink', "$CFG->legacylibdir/form/submitlink.php", 'MoodleQuickForm_submitlink');
MoodleQuickForm::registerElementType('text', "$CFG->legacylibdir/form/text.php", 'MoodleQuickForm_text');
MoodleQuickForm::registerElementType('textarea', "$CFG->legacylibdir/form/textarea.php", 'MoodleQuickForm_textarea');
MoodleQuickForm::registerElementType('date_selector', "$CFG->legacylibdir/form/dateselector.php", 'MoodleQuickForm_date_selector');
MoodleQuickForm::registerElementType('date_time_selector', "$CFG->legacylibdir/form/datetimeselector.php", 'MoodleQuickForm_date_time_selector');
MoodleQuickForm::registerElementType('htmleditor', "$CFG->legacylibdir/form/htmleditor.php", 'MoodleQuickForm_htmleditor');
MoodleQuickForm::registerElementType('format', "$CFG->legacylibdir/form/format.php", 'MoodleQuickForm_format');
MoodleQuickForm::registerElementType('static', "$CFG->legacylibdir/form/static.php", 'MoodleQuickForm_static');
MoodleQuickForm::registerElementType('hidden', "$CFG->legacylibdir/form/hidden.php", 'MoodleQuickForm_hidden');
MoodleQuickForm::registerElementType('modvisible', "$CFG->legacylibdir/form/modvisible.php", 'MoodleQuickForm_modvisible');
MoodleQuickForm::registerElementType('selectyesno', "$CFG->legacylibdir/form/selectyesno.php", 'MoodleQuickForm_selectyesno');
MoodleQuickForm::registerElementType('modgrade', "$CFG->legacylibdir/form/modgrade.php", 'MoodleQuickForm_modgrade');
MoodleQuickForm::registerElementType('cancel', "$CFG->legacylibdir/form/cancel.php", 'MoodleQuickForm_cancel');
MoodleQuickForm::registerElementType('button', "$CFG->legacylibdir/form/button.php", 'MoodleQuickForm_button');
MoodleQuickForm::registerElementType('choosecoursefile', "$CFG->legacylibdir/form/choosecoursefile.php", 'MoodleQuickForm_choosecoursefile');
MoodleQuickForm::registerElementType('choosecoursefileorimsrepo', "$CFG->legacylibdir/form/choosecoursefileorimsrepo.php", 'MoodleQuickForm_choosecoursefileorimsrepo');
MoodleQuickForm::registerElementType('header', "$CFG->legacylibdir/form/header.php", 'MoodleQuickForm_header');
MoodleQuickForm::registerElementType('submit', "$CFG->legacylibdir/form/submit.php", 'MoodleQuickForm_submit');
MoodleQuickForm::registerElementType('questioncategory', "$CFG->legacylibdir/form/questioncategory.php", 'MoodleQuickForm_questioncategory');
MoodleQuickForm::registerElementType('advcheckbox', "$CFG->legacylibdir/form/advcheckbox.php", 'MoodleQuickForm_advcheckbox');
MoodleQuickForm::registerElementType('recaptcha', "$CFG->legacylibdir/form/recaptcha.php", 'MoodleQuickForm_recaptcha');
?>
