...
$plugin->version   = 2008040192;     // release date of this version
$plugin->release   = 'v1-0-92';      // human-friendly version name (used in quizport/output/class.php)
...
if ($moodle_20) {
    ...
    if ($has_taskchain) {
        ...
        $plugin->{'version'} = 2014052092;
        $plugin->{'release'} = '2014-05-20 (92)';
    }
