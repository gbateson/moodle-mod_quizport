...
$plugin->version   = 2008040191;     // release date of this version
$plugin->release   = 'v1-0-91';      // human-friendly version name (used in quizport/output/class.php)
...
if ($moodle_20) {
    ...
    if ($has_taskchain) {
        ...
        $plugin->{'version'} = 2014052091;
        $plugin->{'release'} = '2014-05-20 (91)';
    }
