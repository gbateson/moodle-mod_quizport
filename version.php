...
$plugin->version   = 2008040185;     // release date of this version
$plugin->release   = 'v1.0.85';      // human-friendly version name (used in quizport/output/class.php)
...
if ($moodle_20) {
    ...
    if ($has_taskchain) {
        ...
        $plugin->{'version'} = 2014052085;
        $plugin->{'release'} = '2014.05.20 (85)';
    }
